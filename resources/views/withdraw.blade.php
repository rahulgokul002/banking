                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="container">
                        ...
                        <form action="/withdraws" method="POST">
                            ...
                            <button style="background-color: #4c9bff; color: #fff; padding: 0.75rem 1rem; border: none; cursor: pointer; margin: 0 auto; width: 100%; max-width: 300px;">Withdraw</button>
                        </form>
                    </div>
                </div>
            </div>
