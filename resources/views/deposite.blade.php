            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="container">
                        ...
                        <h1>Deposit Form</h1>
                        <hr>
                        <form action="/deposits" method="POST" style="display: flex; flex-direction: column;">
                            ...
                            <button style="background-color: #4c9bff; color: #fff; padding: 0.75rem 1rem; border: none; cursor: pointer; margin: 0 auto; width: 100%; max-width: 300px;">Deposit</button>
